...
export function useDarkMode() {
  ...
  function initialize() {
    ...
    try {
      window.matchMedia('(prefers-contrast: high)').addEventListener('change', applyContrastPreference)
      window.matchMedia('(prefers-contrast: low)').addEventListener('change', applyContrastPreference)
    } catch {
